...
class App{
    ...
    initPages() {
        ...
        <div id="main">
            ...
            <button id="change" class="mainbtn">重新10连抽</button>
        ...
        const appendTalent = (talent) => {
            this.#xiuXian = this.#xiuXian || (talent.id==1048);
            const li = createTalent(talent);
            talentPage.find('#talents').append(li);
            li.click(()=>{
        ...
        talentPage
            ...
            .click(()=>{
                ...
                (this.#life.getTotal().times > 49) && talentPage.find('#change').show();
            });
        ...
        talentPage
            ...
            .click(()=>{
                ...
                if (this.#xiuXian) {
                    this.hint('选择神秘的小盒子有机会开启修仙人生');
                }else{
                    appendTalent({grade: 3, name: '神秘的小盒子', description: '100岁时才能开启', id: 1048});
                    this.#xiuXian = true
                }
            })
        ...
        <div id="main">
            ...
            <div class="btn-area">
                ...
                <button id="auto2x" class="mainbtn">一眼万年</button>
        ...
        const auto = ()=>{
            if(this.#autoTrajectory) {
                ...
                trajectoryPage.find('#auto').text("自动播放"+(this.#speed < 10?(this.#speed+'x'):""));
            }else{
        ...
        trajectoryPage
            .find('#auto')
            .click(()=>{this.#speed = (this.#speed + 1) % 6;auto();});
        trajectoryPage
            .find('#auto2x')
            .click(()=>{this.#speed = 50;auto();});
